...
- For example, this prevents a nation in Europe from directly recruiting a town in North America since the homeblocks of both towns would be too far from each other. The proximity requirement does not prevent sieges from occurring.
  
-  If one of those nations' towns' homeblocks is close enough to the newly created town's homeblock, the new town can join in the nation. Through careful planning, nations can "chain" together their towns and fill in their claims.
