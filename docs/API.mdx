...
```
{
    "totalVotesAllTime": 62968,
    "totalVotesThisMonth": 7005,
    "totalVotesThisWeek": 0,
    "totalVotesThisDay": 0,
    "votePartyCurrentVotes": 11,
    "votePartyVotesRequired": 100,
    "votePartyVotesNeeded": 89,
    "timeUntilMonthReset": "7 Days 0 Hours 36 Minutes"
}
```
...
{
    "activeSiegeCount": 0,
    "battleSessionTimeTill": "1.4 hours",
      ...
      "sieges": [
        {
          ...
          "status": "In Progress",
          "isActive": true,
          "allowsInvading": false,
          "allowsPlundering": true,
          "attackersWon": false,
          "defendersWon": false,
          "attacker": "Nation_A",
          "defender": "Aiacciu",
