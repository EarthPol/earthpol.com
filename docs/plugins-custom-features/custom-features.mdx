...
description: "Guide to Custom Features on EarthPol, including key mechanics, commands, and tips."
sidebar_position: 1
---
...
*Last updated by [MrTytanic](https://github.com/MrTytanic) on 1 Mar 2026*
</span>
...
[Read more about it here](/docs/war-diplomacy/SiegeWar#-siege-teleport)
...
[Read more about it here](/docs/war-diplomacy/SiegeWar#-ghast-strike)
...
[Read more about it here](/docs/war-diplomacy/SiegeWar#honor-points-system)
...
[Read more about it here](/docs/war-diplomacy/Headhunters)
...
[Read more about it here](/docs/war-diplomacy/TradeWar)
...
[Read more about it here](/docs/economy-trade/TownyPorts)
...
[Read more about it here](/docs/economy-trade/Transportation)
...
This plugin limits how often you can trade with villagers. See the [Villager Trading Guide](./villager-trading-guide) for the current stock, cooldown, discount, and world-specific rules.
